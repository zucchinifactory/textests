...
%
The time spectra in figure \ref{x} to \ref{y} [TODO] all show a single peak which corresponds to the time between the detection of a Compton-scattered electron in one detector and the corresponding photon in the other.
...
\end{align}
%
This yields $\eta_1 = \SI{1.227 \pm 0.025 e-2}{}$ and $\eta_2 = \SI{1.230 \pm 0.025 e-2}{}$. % TODO in Prozent?
%
Random coincidence\\
%
