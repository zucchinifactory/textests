...
Additionally, we proved the validity of common models [TODO Heißt das so?], because the most probable transitions in the available term diagrams were detected.
...
Because $\beta^{+}$ decay of $^{40}\text{K}$ is quite improbable [TODO Quelle?] as well as we are sure that any radioactive samples were removed from the chamber prior to the night measurement, it may actually be likely that there is another isotope around whose decay would explain the measured peak.
%
\par
%
