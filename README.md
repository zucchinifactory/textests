...
This is the `master` branch. It contains the basic `.travis.xml` configuration and is used as a template for creating more complex subprojects with other branches.
